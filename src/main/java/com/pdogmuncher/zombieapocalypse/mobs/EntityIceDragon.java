...
public class EntityIceDragon extends EntityBossDragon implements IBossDisplayData{
	...
	public EntityIceDragon(World worldIn) {
        ...
        this.tasks.addTask(7, new EntityIceDragon.AIFireballAttack());
	...
	public IChatComponent getDisplayName(){
		ChatComponentText message = new ChatComponentText("Ice Dragon");
		ChatStyle colour = new ChatStyle();
		colour.setColor(EnumChatFormatting.WHITE);
    ...
    {
        private EntityGhast field_179470_b = EntityIceDragon.this;
        ...
        public void updateTask()
        {
            ...
            if (entitylivingbase.getDistanceSqToEntity(this.field_179470_b) < d0 * d0 && this.field_179470_b.canEntityBeSeen(entitylivingbase))
            {
                ...
                if (this.field_179471_a == 20)
                {
                    ...
                    EntityIceball entitylargefireball = new EntityIceball(world, this.field_179470_b, d2, d3, d4);
