...
public EntityCar(World par1World, double par2, double par4, double par6)
{
	 this(par1World);
...
public void onUpdate()
{
	 ...
	 if (this.riddenByEntity != null && !worldObj.isRemote && Keyboard.isKeyDown(Keyboard.KEY_D)){
		 this.fuel--;
	 ...
	 if (this.riddenByEntity != null && !worldObj.isRemote && Keyboard.isKeyDown(Keyboard.KEY_A)){
		 this.fuel--;
		 this.setVelocity(this.riddenByEntity.getLookVec().rotateYaw((float) (Math.PI / 2)).xCoord / 2, this.motionY, this.riddenByEntity.getLookVec().rotateYaw((float) (Math.PI / 2)).zCoord / 2);
		 if(isCollidedHorizontally)
         {
	 ...
	 if (this.riddenByEntity != null && !worldObj.isRemote && Keyboard.isKeyDown(Keyboard.KEY_S)){
