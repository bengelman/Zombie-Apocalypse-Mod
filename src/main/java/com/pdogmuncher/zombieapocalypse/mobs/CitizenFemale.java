...
public class CitizenFemale extends EntityTameable{
	public int recharge;
	public EntityPlayer conversing = null;
	public BlockPos homeBase = null;
	public CitizenFemale(World par1World)
    {
        super(par1World);
        this.setSize(0.7F, 1.9F);
        this.setupAI();
        this.setCurrentItemOrArmor(0, new ItemStack(ZombieApocalypse.ak47));
        //this.setCurrentItemOrArmor(4, new ItemStack(BronzeAge.bronzeChestplate));
    }
    int timeSinceChild = 0;
	...
	public boolean interact(EntityPlayer par1EntityPlayer) {
		...
		if (itemstack.getItem() == Items.emerald){
			...
			Survivor vivor = new Survivor (this.worldObj, true);
	...
	public boolean canMateWith(EntityAnimal animal){
		return animal instanceof Citizen || animal instanceof Soldier;
	}
	@Override
	public void readEntityFromNBT(NBTTagCompound arg0) {
		// TODO Auto-generated method stub
		super.readEntityFromNBT(arg0);
		homeBase = new BlockPos(arg0.getInteger("basex"), arg0.getInteger("basey"), arg0.getInteger("basez"));
	}
	@Override
	public void writeEntityToNBT(NBTTagCompound arg0) {
		...
		super.writeEntityToNBT(arg0);
		if (homeBase != null){
			arg0.setInteger("basex", homeBase.getX());
			arg0.setInteger("basey", homeBase.getY());
			arg0.setInteger("basez", homeBase.getZ());
		}
	}
	@Override
