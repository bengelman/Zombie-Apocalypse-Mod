...
public class EntityCosmoDragon extends EntityBossDragon implements IBossDisplayData{
	public double[][] ringBuffer = new double[64][3];
    public int ringBufferIndex = -1;
    public float animTime;
    public float prevAnimTime;
    boolean hasDropped = false;
	public EntityCosmoDragon(World worldIn) {
		super(worldIn);
        ...
        this.tasks.addTask(7, new EntityCosmoDragon.AIFireballAttack());
	...
	public IChatComponent getDisplayName(){
		ChatComponentText message = new ChatComponentText("Cosmo Dragon");
		ChatStyle colour = new ChatStyle();
		colour.setColor(EnumChatFormatting.GREEN);
    ...
    {
        private EntityGhast field_179470_b = EntityCosmoDragon.this;
        ...
        public void updateTask()
        {
            ...
            if (entitylivingbase.getDistanceSqToEntity(this.field_179470_b) < d0 * d0 && this.field_179470_b.canEntityBeSeen(entitylivingbase))
            {
                ...
                if (this.field_179471_a == 20)
                {
                    ...
                    EntityWitherSkull entitylargefireball = new EntityWitherSkull(world, this.field_179470_b, d2, d3, d4);
