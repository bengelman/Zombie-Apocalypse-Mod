...
public class EntityEarthDragon extends EntityBossDragon implements IBossDisplayData{
	public double[][] ringBuffer = new double[64][3];
    public int ringBufferIndex = -1;
    public float animTime;
    public float prevAnimTime;
    boolean hasDropped = false;
	public EntityEarthDragon(World worldIn) {
		super(worldIn);
        ...
        this.tasks.addTask(7, new EntityEarthDragon.AIFireballAttack());
	...
	public IChatComponent getDisplayName(){
		ChatComponentText message = new ChatComponentText("Earth Dragon");
    ...
    {
        private EntityGhast field_179470_b = EntityEarthDragon.this;
        ...
        public void updateTask()
        {
            ...
            if (entitylivingbase.getDistanceSqToEntity(this.field_179470_b) < d0 * d0 && this.field_179470_b.canEntityBeSeen(entitylivingbase))
            {
                ...
                if (this.field_179471_a == 20)
                {
                    ...
                    EntityEarthball entitylargefireball = new EntityEarthball(world, this.field_179470_b, d2, d3, d4, true);
