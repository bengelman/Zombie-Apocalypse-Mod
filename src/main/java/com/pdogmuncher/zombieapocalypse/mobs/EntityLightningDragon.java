...
public class EntityLightningDragon extends EntityBossDragon implements IBossDisplayData{
	...
	public EntityLightningDragon(World worldIn) {
        ...
        this.tasks.addTask(7, new EntityLightningDragon.AIFireballAttack());
	...
	public IChatComponent getDisplayName(){
		ChatComponentText message = new ChatComponentText("Lightning Dragon");
		ChatStyle colour = new ChatStyle();
		colour.setColor(EnumChatFormatting.YELLOW);
    ...
    {
        private EntityGhast field_179470_b = EntityLightningDragon.this;
        ...
        public void updateTask()
        {
            ...
            if (entitylivingbase.getDistanceSqToEntity(this.field_179470_b) < d0 * d0 && this.field_179470_b.canEntityBeSeen(entitylivingbase))
            {
                ...
                if (this.field_179471_a == 20)
                {
                    ...
                    EntityEarthball entitylargefireball = new EntityEarthball(world, this.field_179470_b, d2, d3, d4, false);
