...
public class RenderMobTransporter extends RenderLiving
{
    ...
    public RenderMobTransporter(RenderManager manager, ModelBase par1ModelBase, float par2, String name)
    {
