...
public class RenderCitizenFemale extends RenderLiving
{
    ...
    public RenderCitizenFemale(RenderManager manager, ModelBase par1ModelBase, float par2)
    {
        super(manager, par1ModelBase, par2);
        Your_Texture = new ResourceLocation("minecraft:textures/entity/alex.png");
