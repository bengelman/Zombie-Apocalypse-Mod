...
public class ChunkProviderEpic implements IChunkProvider
{
    private Random rand;
    ...
    public ChunkProviderEpic(World worldIn, long p_i45636_2_, boolean p_i45636_4_, String p_i45636_5_)
    {
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int j3 = 0; j3 < 4; ++j3)
                            {
                                if ((d15 += d16) > 0.0D)
                                {
                                    p_180518_3_.setBlockState(k * 4 + i3, k2 * 8 + l2, j1 * 4 + j3, Blocks.mossy_cobblestone.getDefaultState());
                                }
