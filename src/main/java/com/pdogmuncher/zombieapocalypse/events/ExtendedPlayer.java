...
public class ExtendedPlayer implements IExtendedEntityProperties
{
	...
	*/
	public final static String EXT_PROP_NAME = "ExtendedPlayerZombies";
	...
	*/
	...
	public void saveNBTData(NBTTagCompound compound)
	{
		...
		properties.setBoolean("firstSpawn", this.firstSpawn);
		properties.setBoolean("initialDeath", initialDeath);
	...
	public void loadNBTData(NBTTagCompound compound)
	{
		...
		this.firstSpawn = properties.getBoolean("firstSpawn");
		this.initialDeath = properties.getBoolean("initialDeath");
