...
import com.pdogmuncher.zombieapocalypse.generation.CustomGenLayer;
	   ...
	   public static GenLayer[] initializeAllBiomeGenerators_Tutorial(long par0, WorldType par2WorldType)
	    {
	        ...
	        b0 = (byte) GenLayer.getModdedBiomeSize(par2WorldType, b0);
	        ...
	        GenLayer ret = new CustomGenLayer(200L, genlayer3, par2WorldType);
