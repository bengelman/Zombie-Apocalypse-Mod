...
public CustomBiome(int par1)
{
	...
	this.topBlock = ZombieApocalypse.bronzeBlock.getBlockState().getBaseState();
	//this.topBlock = Blocks.grass.getBlockState().getBaseState();
	this.fillerBlock = ZombieApocalypse.bronzeBlock.getBlockState().getBaseState();
